...
mixin ApiPlay {
  DioMetaData playlistSubscribersDioMetaData(String pid,
    ...
    return DioMetaData(joinUri('/weapi/playlist/subscribers'),
  ...
  Future<PlaylistSubscribersWrap> playlistSubscribers(String pid,
    ...
    return Https.dioProxy
        .postUri(
            playlistSubscribersDioMetaData(pid, offset: offset, limit: limit))
        .then((Response value) {
  ...
  Future<PlaylistCatalogueWrap> playlistCatalogue() {
    return Https.dioProxy
        .postUri(playlistCatalogueDioMetaData())
        .then((Response value) {
  ...
  Future<PlaylistHotTagsWrap> playlistHotTags() {
    return Https.dioProxy
        .postUri(playlistHotTagsDioMetaData())
        .then((Response value) {
  ...
  DioMetaData highqualityPlayListDioMetaData(
    ...
    return DioMetaData(joinUri('/weapi/playlist/highquality/list'),
        data: params, options: joinOptions());
  }
  ...
  Future<MultiPlayListWrap> highqualityPlayList(
      ...
      int lastTime = 0}) {
    return Https.dioProxy
        .postUri(highqualityPlayListDioMetaData(
            category: category, limit: limit, total: total, lastTime: lastTime))
        .then((Response value) {
  ...
  Future<MultiPlayListWrap> relatedPlayList(String songId) {
    return Https.dioProxy
        .getUri(relatedPlayListDioMetaData(songId))
        .then((Response value) {
  ...
  DioMetaData personalizedPlaylistDioMetaData(
    ...
    return DioMetaData(joinUri('/weapi/personalized/playlist'),
        data: params, options: joinOptions());
  }
  ...
  Future<PersonalizedPlayListWrap> personalizedPlaylist(
      {int offset = 0, int limit = 30}) {
    return Https.dioProxy
        .postUri(personalizedPlaylistDioMetaData(offset: offset, limit: limit))
        .then((Response value) {
  ...
  Future<RecommendPlayListWrap> recommendPlaylist() {
    return Https.dioProxy
        .postUri(recommendPlaylistDioMetaData())
        .then((Response value) {
  ...
  DioMetaData playmodeIntelligenceListDioMetaData(
    ...
    return DioMetaData(joinUri('/weapi/playmode/intelligence/list'),
        data: params, options: joinOptions());
  }
  ...
  DioMetaData playListSimiListDioMetaData(String songId,
    ...
    return DioMetaData(joinUri('/weapi/discovery/simiPlaylist'),
        data: params, options: joinOptions());
  }
  ...
  Future<MultiPlayListWrap> playListSimiList(String songId,
    ...
    return Https.dioProxy
        .postUri(
            playListSimiListDioMetaData(songId, offset: offset, limit: limit))
        .then((Response value) {
      return MultiPlayListWrap.fromJson(value.data);
    });
  }
  ...
  DioMetaData playListDetailDioMetaData(String categoryId, {int subCount = 5}) {
    ...
    return DioMetaData(
        Uri.parse('https://interface3.music.163.com/api/playlist/v4/detail'),
        data: params,
        options: joinOptions());
  }
  ...
  Future<SinglePlayListWrap> playListDetail(String categoryId,
      {int subCount = 5}) {
    return Https.dioProxy
        .postUri(playListDetailDioMetaData(categoryId, subCount: subCount))
        .then((Response value) {
  ...
  DioMetaData categorySongListDioMetaData({
    ...
    return DioMetaData(joinUri('/weapi/playlist/list'),
        data: params, options: joinOptions());
  }
  ...
  Future<MultiPlayListWrap> categorySongList({
    ...
    return Https.dioProxy
        .postUri(categorySongListDioMetaData(
            category: category,
            order: order,
            offset: offset,
            limit: limit,
  ...
  Future<RecommendSongListWrapX> recommendSongList() {
    return Https.dioProxy
        .postUri(recommendSongListDioMetaData())
        .then((Response value) {
  ...
  Future<RecommendSongListHistoryWrapX> recommendSongListHistory() {
    return Https.dioProxy
        .postUri(recommendSongListHistoryDioMetaData())
        .then((Response value) {
  ...
  Future<RecommendSongListHistoryWrapX> recommendSongListHistoryDetail(
      {String date = ''}) {
    return Https.dioProxy
        .postUri(recommendSongListHistoryDetailDioMetaData(date: date))
        .then((Response value) {
      return RecommendSongListHistoryWrapX.fromJson(value.data);
    });
  }
  ...
  DioMetaData userRadioTrashDioMetaData(String songId,
    ...
    return DioMetaData(
        joinUri('/weapi/radio/trash/add?alg=$alg&songId=$songId&time=$time'),
        data: params,
        options: joinOptions());
  }
  ...
  Future<SongListWrap> userRadioTrash(String songId,
      {int time = 3, String alg = 'RT'}) {
    return Https.dioProxy
        .postUri(userRadioTrashDioMetaData(songId, time: time, alg: alg))
        .then((Response value) {
  ...
  Future<PersonalizedSongListWrap> personalizedSongList() {
    return Https.dioProxy
        .postUri(personalizedSongListDioMetaData())
        .then((Response value) {
  ...
  Future<SongListWrap2> newSongList({String areaId = '0'}) {
    return Https.dioProxy
        .postUri(newSongListDioMetaData(areaId: areaId))
        .then((Response value) {
      return SongListWrap2.fromJson(value.data);
    });
  }
  ...
  Future<UserListWrap> userSongSimiList(String songId) {
    return Https.dioProxy
        .postUri(userSongSimiListDioMetaData(songId))
        .then((Response value) {
  ...
  DioMetaData songSimiListDioMetaData(String songId,
      {int offset = 0, int limit = 30}) {
    var params = {'songid': songId, 'limit': limit, 'offset': offset};
    return DioMetaData(joinUri('/weapi/v1/discovery/simiSong'),
        data: params, options: joinOptions());
  }
  ...
  Future<SongListWrap> songSimiList(String songId,
      {int offset = 0, int limit = 30}) {
    return Https.dioProxy
        .postUri(songSimiListDioMetaData(songId, offset: offset, limit: limit))
        .then((Response value) {
      return SongListWrap.fromJson(value.data);
    });
  }
  ...
  Future<LikeSongListWrap> likeSongList(String userId) {
    return Https.dioProxy
        .postUri(likeSongListDioMetaData(userId))
        .then((Response value) {
  ...
  Future<ServerStatusBean> cloudSongDetail(List<String> songIds) {
    return Https.dioProxy
        .postUri(cloudSongDetailDioMetaData(songIds))
        .then((Response value) {
  ...
  Future<CloudSongListWrap> cloudSongDelete(List<String> songIds) {
    return Https.dioProxy
        .postUri(cloudSongDeleteDioMetaData(songIds))
        .then((Response value) {
      return CloudSongListWrap.fromJson(value.data);
    });
  }
  ...
  Future<ServerStatusBean> likeSong(String songId, bool like,
      {int time = 3, String alg = 'itembased'}) {
    return Https.dioProxy
        .postUri(likeSongDioMetaData(songId, like, time: time, alg: alg))
        .then((Response value) {
      return ServerStatusBean.fromJson(value.data);
    });
  }
  ...
  Future<SongDetailWrap> songDetail(List<String> songIds) {
    return Https.dioProxy
        .postUri(songDetailDioMetaData(songIds))
        .then((Response value) {
  ...
  DioMetaData songUrlDioMetaData(List<String> songIds, {int br = 999000}) {
    ...
    return DioMetaData(joinUri('/api/song/enhance/player/url'),
        data: params,
        options: joinOptions(
  ...
  Future<SongUrlListWrap> songUrl(List<String> songIds, {int br = 999000}) {
    return Https.dioProxy
        .postUri(songUrlDioMetaData(songIds, br: br))
        .then((Response value) {
  ...
  Future<SongLyricWrap> songLyric(String songId) {
    return Https.dioProxy
        .postUri(songLyricDioMetaData(songId))
        .then((Response value) {
  ...
  DioMetaData songAvailableCheckDioMetaData(List<String> songIds,
      {int br = 999000}) {
    var params = {'ids': songIds, 'br': br};
    return DioMetaData(joinUri('/weapi/song/enhance/player/url'),
        data: params, options: joinOptions());
  }
  ...
  Future<SongUrlListWrap> songAvailableCheck(List<String> songIds,
      {int br = 999000}) {
    return Https.dioProxy
        .postUri(songAvailableCheckDioMetaData(songIds, br: br))
        .then((Response value) {
      return SongUrlListWrap.fromJson(value.data);
    });
  }
  ...
  DioMetaData artistListDioMetaData(int initial,
    ...
    return DioMetaData(joinUri('/api/v1/artist/list'),
        data: params, options: joinOptions());
  }
  ...
  Future<ArtistsListWrap> artistList(int initial,
      ...
      int area = -1}) {
    return Https.dioProxy
        .postUri(artistListDioMetaData(initial,
            offset: offset, limit: limit, total: total, type: type, area: area))
        .then((Response value) {
  ...
  DioMetaData topArtistDioMetaData(
    ...
    return DioMetaData(joinUri('/weapi/artist/top'),
        data: params, options: joinOptions());
  }
  ...
  Future<ArtistsListWrap> topArtist(
    ...
    return Https.dioProxy
        .postUri(
            topArtistDioMetaData(offset: offset, limit: limit, total: total))
        .then((Response value) {
      return ArtistsListWrap.fromJson(value.data);
    });
  }
  ...
  DioMetaData artistTopListDioMetaData(
    ...
    return DioMetaData(joinUri('/weapi/toplist/artist'),
        data: params, options: joinOptions());
  }
  ...
  Future<ArtistsTopListWrapX> artistTopList(
      {int type = 1, int offset = 0, int limit = 30, bool total = true}) {
    return Https.dioProxy
        .postUri(artistTopListDioMetaData(
            type: type, offset: offset, limit: limit, total: total))
        .then((Response value) {
  ...
  Future<ArtistsListWrap> artistSimiList(String artistId) {
    return Https.dioProxy
        .postUri(artistSimiListDioMetaData(artistId))
        .then((Response value) {
      return ArtistsListWrap.fromJson(value.data);
    });
  }
  ...
  Future<ArtistDescWrap> artistDesc(String artistId) {
    return Https.dioProxy
        .postUri(artistDescDioMetaData(artistId))
        .then((Response value) {
  ...
  DioMetaData allMvListDioMetaData(
    ...
    return DioMetaData(Uri.parse('https://interface.music.163.com/api/mv/all'),
        data: params, options: joinOptions());
  }
  ...
  DioMetaData topMvListDioMetaData(
    ...
    return DioMetaData(joinUri('/weapi/mv/toplist'),
        data: params, options: joinOptions());
  }
  ...
  DioMetaData newestMvListDioMetaData(
    ...
    return DioMetaData(
        Uri.parse('https://interface.music.163.com/weapi/mv/first'),
        data: params,
        options: joinOptions());
  }
  ...
  Future<MvListWrap2> newestMvList(
      {String area = '', int offset = 0, int limit = 30, bool total = true}) {
    return Https.dioProxy
        .postUri(newestMvListDioMetaData(
            area: area, offset: offset, limit: limit, total: total))
        .then((Response value) {
      return MvListWrap2.fromJson(value.data);
    });
  ...
  Future<MvListWrap2> neteaseMvList(
      {int offset = 0, int limit = 30, bool total = true}) {
    return Https.dioProxy
        .postUri(neteaseMvListDioMetaData(
  ...
  Future<PersonalizedMvListWrap> personalizedMvList() {
    return Https.dioProxy
        .postUri(personalizedMvListDioMetaData())
        .then((Response value) {
  ...
  DioMetaData artistMvListDioMetaData(String artistId,
    ...
    return DioMetaData(joinUri('/weapi/artist/mvs'),
        data: params, options: joinOptions());
  }
  ...
  Future<ArtistMvListWrap> artistMvList(String artistId,
      {int offset = 0, int limit = 30, bool total = true}) {
    return Https.dioProxy
        .postUri(artistMvListDioMetaData(artistId,
            offset: offset, limit: limit, total: total))
        .then((Response value) {
  ...
  Future<MvListWrap> mvSimiList(String mvId) {
    return Https.dioProxy
        .postUri(mvSimiListDioMetaData(mvId))
        .then((Response value) {
  ...
  Future<MvDetailWrap> mvDetail(String mvId) {
    return Https.dioProxy
        .postUri(mvDetailDioMetaData(mvId))
        .then((Response value) {
  ...
  Future<MvDetailInfoWrap> mvDetailInfo(String mvId) {
    return Https.dioProxy
        .postUri(mvDetailInfoDioMetaData(mvId))
        .then((Response value) {
  ...
  Future<MvUrlWrap> mvUrl(String mvId, {int resolution = 1080}) {
    return Https.dioProxy
        .postUri(mvUrlDioMetaData(mvId, resolution: resolution))
        .then((Response value) {
  ...
  DioMetaData videoCategoryListDioMetaData(
    ...
    var params = {'total': total, 'limit': limit, 'offset': offset};
    return DioMetaData(joinUri('/api/cloudvideo/category/list'),
        data: params, options: joinOptions());
  }
  ...
  Future<VideoMetaListWrap> videoCategoryList(
      {int offset = 0, int limit = 99, bool total = true}) {
    return Https.dioProxy
        .postUri(videoCategoryListDioMetaData(
            offset: offset, limit: limit, total: total))
        .then((Response value) {
  ...
  Future<VideoMetaListWrap> videoGroupList() {
    return Https.dioProxy
        .postUri(videoGroupListDioMetaData())
        .then((Response value) {
      return VideoMetaListWrap.fromJson(value.data);
    });
  }
  ...
  DioMetaData videoListByGroupDioMetaData(String groupId,
    ...
    return DioMetaData(joinUri('/api/videotimeline/videogroup/otherclient/get'),
        data: params, options: joinOptions());
  }
  ...
  Future<VideoListWrapX> videoListByGroup(String groupId,
    ...
    return Https.dioProxy
        .postUri(
            videoListByGroupDioMetaData(groupId, offset: offset, total: total))
        .then((Response value) {
  ...
  DioMetaData videoListOtherDioMetaData(String groupId,
    ...
    return DioMetaData(joinUri('/api/videotimeline/otherclient/get'),
        data: params, options: joinOptions());
  }
  ...
  Future<VideoListWrapX> videoListOther(String groupId,
    ...
    return Https.dioProxy
        .postUri(
            videoListOtherDioMetaData(groupId, offset: offset, total: total))
        .then((Response value) {
      return VideoListWrapX.fromJson(value.data);
    });
  }
  ...
  Future<VideoListWrapX> videoList({int offset = 0}) {
    return Https.dioProxy
        .postUri(videoListDioMetaData(offset: offset))
        .then((Response value) {
      return VideoListWrapX.fromJson(value.data);
    });
  }
  ...
  DioMetaData relatedVideoListDioMetaData(String videoId) {
    ...
    return DioMetaData(joinUri('/weapi/cloudvideo/v1/allvideo/rcmd'),
        data: params, options: joinOptions());
  }
  ...
  Future<VideoListWrap> relatedVideoList(String videoId) {
    return Https.dioProxy
        .postUri(relatedVideoListDioMetaData(videoId))
        .then((Response value) {
  ...
  Future<VideoDetailWrap> videoDetail(String videoId) {
    return Https.dioProxy
        .postUri(videoDetailDioMetaData(videoId))
        .then((Response value) {
  ...
  Future<VideoDetailInfoWrap> videoDetailInfo(String videoId) {
    return Https.dioProxy
        .postUri(videoDetailInfoDioMetaData(videoId))
        .then((Response value) {
  ...
  DioMetaData videoUrlDioMetaData(List<String> videoIds,
    ...
    return DioMetaData(joinUri('/weapi/cloudvideo/playurl'),
        data: params, options: joinOptions());
  }
  ...
  Future<VideoUrlWrap> videoUrl(List<String> videoIds,
      {int resolution = 1080}) {
    return Https.dioProxy
        .postUri(videoUrlDioMetaData(videoIds, resolution: resolution))
        .then((Response value) {
  ...
  DioMetaData artistAlbumListDioMetaData(String artistId,
      {int offset = 0, int limit = 30, bool total = true}) {
    var params = {'total': total, 'limit': limit, 'offset': offset};
    return DioMetaData(joinUri('/weapi/artist/albums/$artistId'),
        data: params, options: joinOptions());
  }
  ...
  Future<ArtistAlbumListWrap> artistAlbumList(String artistId,
      {int offset = 0, int limit = 30, bool total = true}) {
    return Https.dioProxy
        .postUri(artistAlbumListDioMetaData(artistId,
            offset: offset, limit: limit, total: total))
        .then((Response value) {
  ...
  DioMetaData newestAlbumListDioMetaData() {
    return DioMetaData(joinUri('/api/discovery/newAlbum'),
        data: {}, options: joinOptions());
  }
  ...
  Future<AlbumListWrap> newestAlbumList() {
    return Https.dioProxy
        .postUri(newestAlbumListDioMetaData())
        .then((Response value) {
      return AlbumListWrap.fromJson(value.data);
    });
  }
  ...
  DioMetaData albumDetailDioMetaData(String albumId) {
    return DioMetaData(joinUri('/weapi/v1/album/$albumId'),
        data: {}, options: joinOptions());
  }
  ...
  Future<AlbumDetailWrap> albumDetail(String albumId) {
    return Https.dioProxy
        .postUri(albumDetailDioMetaData(albumId))
        .then((Response value) {
  ...
  DioMetaData albumDetailDynamicDioMetaData(String albumId) {
    ...
    return DioMetaData(joinUri('/api/album/detail/dynamic'),
        data: params, options: joinOptions());
  }
  ...
  Future<AlbumDetailDynamicWrap> albumDetailDynamic(String albumId) {
    return Https.dioProxy
        .postUri(albumDetailDynamicDioMetaData(albumId))
        .then((Response value) {
